...
import 'addshedule.dart';

class ParentCare extends ConsumerStatefulWidget {
  @override
...
class _ParentCare extends ConsumerState<ParentCare>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 242, 243, 249),
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: Color.fromARGB(255, 242, 243, 249),
        title: Text(
        ...
        actions: [
          IconButton(
            icon: const Icon(FontAwesome.sign_out,
                size: 14, color: Color.fromARGB(255, 181, 194, 0)),
            onPressed: () {
              signout();
